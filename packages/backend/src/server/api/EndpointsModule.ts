...
const $admin_federation_removeAllFollowee: Provider = { provide: 'ep:admin/federation/remove-all-followee', useClass: ep___admin_federation_removeAllFollowee.default };
...
@Module({
	...
	providers: [
		...
		$admin_federation_removeAllFollowee,
